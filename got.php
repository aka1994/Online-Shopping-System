...
<footer class="container">
	<div class="row">	
		<p class="col-sm-6">
			&copy; 2019 ThinkGeek | Made by &nbsp; <b>AkaLeo</b>&nbsp; in India
		</p>

		<ul class="col-sm-6">
			<li class="col-sm-1">
				<a href="mailto:hjleonard47@outlook.com" target="_blank">
					<img src="res/social media/help.png">
				</a>
			</li>
			<li class="col-sm-1">
				<a href="https://twitter.com/hjleonard47" target="_blank">
					<img src="res/social media/twitter.png">
				</a>
			</li>
			<li class="col-sm-1">
				<a href="https://www.facebook.com/hjleonard47" target="_blank">
			...
			<li class="col-sm-1">
				<a href="https://www.instagram.com/hjleonard47/" target="_blank">
